    ...
    with open(args.yaml) as f:
        ...
        for sample in sorted(doc["samples"].keys()):
            ...
            for name in sorted(info["datasets"].keys()):
                ...
                this_config.General.workArea = 'DijetSkim/{}'.format(production_tag)
                ...
                units_per_job = info.get("unitsPerJob", common[common_branch].get("unitsPerJob", None))
                if units_per_job:
                    this_config.Data.unitsPerJob = units_per_job
