...
job_name = "DijetSkim_JetHTRun2016Bver1_1_0_0"
...
config.JobType.scriptArgs = ["source=data", "dataset=JetHT", "year=2016"]
...
config.Data.inputDataset = '/JetHT/Run2016B_ver1-Nano14Dec2018_ver1-v1/NANOAOD'