...
job_name = "DijetSkim_JetHTRun2017D_1_0_1"
...
config.JobType.scriptArgs = ["--source=data", "--dataset=JetHT", "--year=2017"]
...
config.Data.inputDataset = '/JetHT/Run2017D-Nano14Dec2018-v1/NANOAOD'