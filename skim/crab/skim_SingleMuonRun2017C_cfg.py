...
job_name = "DijetSkim_SingleMuonRun2017C_1_0_1"
...
config.JobType.scriptArgs = ["--source=data", "--dataset=SingleMuon", "--year=2017"]
...
config.Data.inputDataset = '/SingleMuon/Run2017C-Nano14Dec2018-v1/NANOAOD'