...
job_name = "DijetSkim_JetHTRun2018Dver2_1_0_0"
...
config.JobType.scriptArgs = ["source=data", "dataset=JetHT", "year=2018"]
...
config.Data.inputDataset = '/JetHT/Run2018D-Nano14Dec2018_ver2-v1/NANOAOD'