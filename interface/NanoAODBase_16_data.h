...
#ifndef NanoAOD_16_data_h
#define NanoAOD_16_data_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         Electron_mvaSpring16GP[10];   //[nElectron]
   Float_t         Electron_mvaSpring16HZZ[10];   //[nElectron]
   ...
   Int_t           Electron_cutBased_HLTPreSel[10];   //[nElectron]
   Int_t           Electron_cutBased_Spring15[10];   //[nElectron]
   Int_t           Electron_cutBased_Sum16[10];   //[nElectron]
   ...
   Int_t           Electron_vidNestedWPBitmapSpring15[10];   //[nElectron]
   Int_t           Electron_vidNestedWPBitmapSum16[10];   //[nElectron]
   ...
   Bool_t          Electron_mvaSpring16GP_WP80[10];   //[nElectron]
   Bool_t          Electron_mvaSpring16GP_WP90[10];   //[nElectron]
   Bool_t          Electron_mvaSpring16HZZ_WPL[10];   //[nElectron]
   UInt_t          nFatJet;
   ...
   Float_t         Photon_mvaID17[10];   //[nPhoton]
   ...
   Int_t           Photon_cutBased17Bitmap[10];   //[nPhoton]
   ...
   Bool_t          Photon_mvaID17_WP80[10];   //[nPhoton]
   Bool_t          Photon_mvaID17_WP90[10];   //[nPhoton]
   ...
   NanoAOD_16_data(TTree *tree=0);
   virtual ~NanoAOD_16_data();
...
#ifdef NanoAOD_16_data_cxx
NanoAOD_16_data::NanoAOD_16_data(TTree *tree) : fChain(0) 
{
...
NanoAOD_16_data::~NanoAOD_16_data()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t NanoAOD_16_data::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t NanoAOD_16_data::LoadTree(Long64_t entry)
{
...
void NanoAOD_16_data::Init(TTree *tree)
{
...
void NanoAOD_16_data::Show(Long64_t entry)
{
...
Int_t NanoAOD_16_data::Cut(Long64_t entry)
{
...
#endif // #ifdef NanoAOD_16_data_cxx
