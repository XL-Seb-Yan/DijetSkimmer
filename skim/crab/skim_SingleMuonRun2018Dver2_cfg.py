...
job_name = "DijetSkim_SingleMuonRun2018Dver2_1_0_1"
...
config.JobType.scriptArgs = ["source=data", "dataset=SingleMuon", "year=2018"]
...
config.Data.inputDataset = '/SingleMuon/Run2018D-Nano14Dec2018_ver2-v1/NANOAOD'